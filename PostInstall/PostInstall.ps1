...
function download-resources {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/LePastis/Cloud-GPU-Updater/master/GPUUpdaterTool.ps1", "$env:ProgramData\ParsecLoader\GPUUpdaterTool.ps1")
